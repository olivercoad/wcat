...
# RUN env CGO_ENABLED=0 GOOS=darwin GOARCH=386 go build -o /wcat/bin/darwin-386.exe
RUN env CGO_ENABLED=0 GOOS=darwin GOARCH=amd64 go build -o /wcat/bin/darwin-amd64.exe
